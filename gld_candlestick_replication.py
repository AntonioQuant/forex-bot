"""
gld_candlestick_replication.py
Misma metodología exacta que en SPY y BTC, aplicada a GLD (oro) --
una clase de activo completamente distinta, con dinámica de refugio
en vez de riesgo, y participantes de mercado distintos.

Uso:
    python3 gld_candlestick_replication.py
"""
...
HORIZONTE = 10
COSTE_IDA_Y_VUELTA = 0.0005  # mismo coste conservador que usamos en SPY
