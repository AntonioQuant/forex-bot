"""
aapl_candlestick_replication.py
Misma metodología exacta que en SPY, GLD y BTC, aplicada a AAPL --
una acción individual líquida, en vez de un índice diversificado, para
ver si el patrón sobrevive sin el "suavizado" que da la diversificación.

Uso:
    python3 aapl_candlestick_replication.py
"""
